...
export default function NotFound() {
  return (
    <div className="min-h-[80vh] flex items-center justify-center p-4">
      <div className="w-full max-w-lg bg-white border border-slate-200 rounded-3xl shadow-xl overflow-hidden text-center p-6 sm:p-10 animate-fade-in">
        <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-2xl bg-slate-100 border border-slate-200 text-slate-500 mb-6">
        ...
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-2.5 text-left">
          <Link
            href="/dashboard"
            prefetch={false}
            className="flex flex-col p-3.5 rounded-xl border border-slate-200 hover:border-primary/40 hover:bg-slate-50 transition-all group"
          >
          ...
          <Link
            href="/depot"
            prefetch={false}
            className="flex flex-col p-3.5 rounded-xl border border-slate-200 hover:border-emerald-500/40 hover:bg-emerald-50/40 transition-all group"
          >
          ...
          <Link
            href="/products"
            prefetch={false}
            className="flex flex-col p-3.5 rounded-xl border border-slate-200 hover:border-blue-500/40 hover:bg-blue-50/40 transition-all group"
          >
